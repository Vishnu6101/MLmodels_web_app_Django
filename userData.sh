...
GIT_REPO_URL="https://github.com/Vishnu6101/MLmodels_web_app_Django.git"
...
PROJECT_MAIN_DIR_NAME="MLmodels"

# Clone repository
git clone -b deployment "$GIT_REPO_URL" "/home/ubuntu/$PROJECT_MAIN_DIR_NAME"
